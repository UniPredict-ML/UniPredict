      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center">
          ...
          <div className="flex justify-center">
            <Link
              to="/unipredict"
              className="w-40 bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-lg font-semibold transition-colors ">
              Get Started
            </Link>
          </div>
        </div>

        <div className="mt-20 grid md:grid-cols-3 gap-1 place-items-center">

          <div className="card bg-white rounded-lg p-6 shadow-lg">
